...
def make_autogenerated_comment(script_relpath: str) -> str:
    """Returns a standardized banner comment warning that the HTML file is auto-generated."""
  ...
  - Update the template or generator logic in preview/generator/
  =============================================================================
-->"""
