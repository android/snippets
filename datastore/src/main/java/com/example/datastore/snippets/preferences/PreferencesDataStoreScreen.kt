...
@Composable
internal fun PreferencesDataStoreScreen() {
    ...
    Column(Modifier.fillMaxSize()) {
        ...
        // [START android_datastore_preferences_compose_sample]
        ...
        // [END android_datastore_preferences_compose_sample]

        // Update the counter using helper function.
        Button(
            onClick = {
                coroutineScope.launch { preferencesDataStore.incrementCounterWithEdit() }
            }
        ) {
            Text("increment with edit")
        }
    }
}