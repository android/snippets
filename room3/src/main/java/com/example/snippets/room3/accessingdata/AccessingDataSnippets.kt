...
private object SimpleDaoExample {
    ...
    // [START room_3_accessing_data_simple_dao]
    @Dao
    interface UserDao {
        @Insert
    ...
    // [END room_3_accessing_data_simple_dao]
}
...
private object InsertConvenienceExample {
    ...
    // [START room_3_accessing_data_insert_convenience]
    @Dao
    interface UserDao {
    ...
    // [END room_3_accessing_data_insert_convenience]
}
...
private object UpdateConvenienceExample {
    ...
    // [START room_3_accessing_data_update_convenience]
    @Dao
    interface UserDao {
        @Update
        suspend fun updateUsers(vararg users: User)
    }
    // [END room_3_accessing_data_update_convenience]
}
...
private object DeleteConvenienceExample {
    ...
    // [START room_3_accessing_data_delete_convenience]
    @Dao
    interface UserDao {
        @Delete
        suspend fun deleteUsers(vararg users: User)
    }
    // [END room_3_accessing_data_delete_convenience]
}
...
private object UpsertConvenienceExample {
    ...
    // [START room_3_accessing_data_upsert_convenience]
    @Dao
    interface UserDao {
        @Upsert
        suspend fun upsertUsers(vararg users: User)
    }
    // [END room_3_accessing_data_upsert_convenience]
}
...
private object QueryExamples {
    ...
    @Dao
    interface UserDao {
        // [START room_3_accessing_data_simple_query]
        @Query("SELECT * FROM user")
        suspend fun loadAllUsers(): List<User>
        // [END room_3_accessing_data_simple_query]

        // [START room_3_accessing_data_query_param]
        @Query("SELECT * FROM user WHERE age > :minAge")
        suspend fun loadAllUsersOlderThan(minAge: Int): Array<User>
        // [END room_3_accessing_data_query_param]

        // [START room_3_accessing_data_query_params]
        ...
        // [END room_3_accessing_data_query_params]

        // [START room_3_accessing_data_query_collection]
        @Query("SELECT * FROM user WHERE region IN (:regions)")
        suspend fun loadUsersFromRegions(regions: List<String>): List<User>
        // [END room_3_accessing_data_query_collection]

        // [START room_3_accessing_data_query_multitable]
        @Query(
            """
            SELECT * FROM book
        ...
        // [END room_3_accessing_data_query_multitable]

        // [START room_3_accessing_data_multimap]
        @Query(
            """
            SELECT * FROM user
        ...
        // [END room_3_accessing_data_multimap]

        // [START room_3_accessing_data_multimap_groupby]
        @Query(
            """
            SELECT * FROM user
            JOIN book ON user.id = book.user_id
        ...
        // [END room_3_accessing_data_multimap_groupby]

        // [START room_3_accessing_data_multimap_mapcolumn]
        @Query(
            """
        ...
        >
        // [END room_3_accessing_data_multimap_mapcolumn]
    }

    // [START room_3_accessing_data_subset_query_tuple]
    data class NameTuple(
        @ColumnInfo(name = "first_name") val firstName: String,
        @ColumnInfo(name = "last_name") val lastName: String
    )
    // [END room_3_accessing_data_subset_query_tuple]

    @Dao
    interface SubsetDao {
        // [START room_3_accessing_data_subset_query_method]
        @Query("SELECT first_name, last_name FROM user")
        suspend fun loadFullName(): List<NameTuple>
        // [END room_3_accessing_data_subset_query_method]
    }

    // [START room_3_accessing_data_query_flow]
    ...
    // [END room_3_accessing_data_query_flow]
}
...
private object PagingExample {
    ...
    // [START room_3_accessing_data_paging]
    @Dao
...
private class ConnectionExamples(val roomDatabase: RoomDatabase) {
    suspend fun runConnectionReader(minAge: Int) {
        ...
        // [END room_3_accessing_data_connection_reader]
    }

    suspend fun runConnectionWriter() {
        // [START room_3_accessing_data_connection_transaction]
        roomDatabase.useWriterConnection { transactor ->
            transactor.immediateTransaction {
                // Perform transactional database operations using transactor
            }
        }
        // [END room_3_accessing_data_connection_transaction]
    }
}
...
private object TransactionExample {
    ...
    suspend fun runTransactionExamples(roomDatabase: RoomDatabase, userDao: UserDao, newUser: User, existingUser: User) {
        // [START room_3_accessing_data_highlevel_transaction]
        ...
        // [END room_3_accessing_data_highlevel_transaction]
    }
}
