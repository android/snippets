...
private object OneShotObservableExamples {
    ...
    // [START room_3_async_queries_oneshot]
    @Dao
    interface UserDao {
    ...
    // [END room_3_async_queries_oneshot]

    // [START room_3_async_queries_observable]
    @Dao
    ...
    // [END room_3_async_queries_observable]
}
...
private object InvalidationTrackerExample {
    ...
    // [START room_3_async_queries_invalidation]
    ...
    // [END room_3_async_queries_invalidation]
}

// Custom converters examples
// [START room_3_async_queries_custom_converter]
...
// [END room_3_async_queries_custom_converter]

private object UseCustomConverterExample {
    // [START room_3_async_queries_use_custom_converter]
    @Dao
    ...
    // [END room_3_async_queries_use_custom_converter]
}
...
private object ProvidedConverterExample {
    ...
    // [START room_3_async_queries_provided_converter]
    ...
    // [END room_3_async_queries_provided_converter]

    fun createDb(applicationContext: android.content.Context) {
        // [START room_3_async_queries_register_provided]
        val db = Room.databaseBuilder<MyDatabase>(applicationContext, "database-name")
          ...
          .build()
        // [END room_3_async_queries_register_provided]
    }
}
