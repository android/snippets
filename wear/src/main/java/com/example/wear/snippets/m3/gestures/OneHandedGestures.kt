 ...
 *
 * To compile and test this snippet locally, pass `-PwearSnapshotVersion=1.7.0-SNAPSHOT` to Gradle:
 *     ./gradlew :wear:assembleDebug -PwearSnapshotVersion=1.7.0-SNAPSHOT
 */
